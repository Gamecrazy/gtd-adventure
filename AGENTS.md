...
- Keep the HTML workbench self-contained. The application entry point is `index.html` at the repository root; tests live in `tests/`, and `docs/` contains documentation only.

...
- This repository contains standalone UI prototypes, not the production GTD application. Do not add production credentials, hosting configuration, private migration records, or real user data.
...
- The assistant is phase two and is not implemented in these prototypes.
- Keep HTML artifacts self-contained. Preserve original prototypes as design history unless the user asks to change them.

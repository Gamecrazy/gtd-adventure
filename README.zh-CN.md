...
**当前可交互版本：v8.2。** 文件名保留为 [`gtd-adventure-workbench-v8.html`](./docs/prototypes/gtd-adventure-workbench-v8.html)，便于延续本地体验记录。
...
3. 顶部应显示 **“v8.2 · Bilingual workbench”**，默认打开英文界面，右上角可切换到中文。如果仍看到旧版标题，请确认打开的是本仓库中的最新文件。
...
- 当前 v8.2 工作台首次打开默认使用英文，不跟随浏览器语言。
...
目前有 **37 项 DOM 与交互检查**，覆盖页签切换、键盘导航、事项流转、草稿保留、完成与恢复、旧版记录兼容、存储失败、默认英文、双语切换、翻译完整性，以及用户原文保留和安全文本展示。
...
本仓库仅保留当前勇者冒险工作台、设计原则与测试。旧版原型文件已从当前分支移除，仍可通过 Git 提交记录恢复。本仓库不包含原 GTD 应用的后端代码、部署配置、私人迁移记录或原项目 Git 历史。当前没有配置在线托管；公开 GitHub 仓库不代表已经发布在线演示站点。

- `docs/prototypes/`：当前勇者冒险双语工作台。
- `docs/prototypes/tests/`：37 项交互回归检查。
